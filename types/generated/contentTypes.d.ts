...
export interface ApiApplicationApplication extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    coverLetter: Schema.Attribute.RichText;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    publishedAt: Schema.Attribute.DateTime;
    qualification: Schema.Attribute.Enumeration<
      ['not_assessed', 'fail', 'pass', 'reserve']
    > &
...
export interface ApiContactMessageContactMessage
  ...
  attributes: {
    contactStatus: Schema.Attribute.Enumeration<['new', 'read']> &
...
export interface ApiEventEvent extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    mode: Schema.Attribute.Enumeration<['in-person', 'online', 'hybrid']> &
...
export interface ApiNewsArticleNewsArticle extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    content_blocks: Schema.Attribute.Component<'shared.content-block', true>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiProjectProject extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    projectStatus: Schema.Attribute.Enumeration<['ongoing', 'completed']> &
      Schema.Attribute.Required &
...
export interface ApiVacancyVacancy extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    requiredCandidates: Schema.Attribute.Integer &
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    vacancyStatus: Schema.Attribute.Enumeration<['opened', 'closed']> &
      Schema.Attribute.Required &
